...
# local imports
from .serializers import (CompleteProfileSerializer, RetrieveProfileSerializer,
                          UpdateProfileSerializer, NextOfKinSerializer)
...
class CreateNextofKin(GenericAPIView):
